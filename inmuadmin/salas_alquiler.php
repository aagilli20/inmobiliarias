...
for ($i=0; $i < count($domicilio_list); $i++) {
	...
	$r=$conn->insertar_alquiler($domicilio_list[$i], "Santa Fe", $tipo_list[$i], '0', $barrio_list[$i], $precio_list[$i], $img_list[$i], $url_list[$i], 1);
	// echo "<br>".$r;
	} else {
		if(strlen($dormitorios_list[$i]) == 0){
			...
			$r=$conn->insertar_alquiler($domicilio_list[$i], "Santa Fe", $tipo_list[$i], $dormitorios_list[$i], $barrio_list[$i], $precio_list[$i], $img_list[$i], $url_list[$i], 1);
			// echo "<br>".$r;
		}		
	}		
}
